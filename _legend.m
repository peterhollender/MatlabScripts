...
if ~isempty(children) || ~isempty(strings) || new_legend
    ...
    set_children_and_strings(ha,leg,children,strings,new_legend);
end
...
strings = strings(:).';
if isempty(autoupdate) && ~isempty(children)
    autoupdate = 'off';
end
...
%----------------------------------------------------------------%
function set_children_and_strings(ha,hLeg,ch_in,str,new_legend)
